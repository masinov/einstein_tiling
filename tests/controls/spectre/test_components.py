...
from einstein.tilings.spectre.patches import IDENTITY
from einstein.tilings.spectre.source_controls import physical_corona_language
...
def _language():
    ...
    return physical_corona_language(artifact)
