...
**Last updated:** 2026-07-24 (session 159 HC-37 selector normal form)
...
| ST-M1 — Sturmian monotile encoding | outside-horizon theorem branch | 🟡 HC-37 active: K36P now has an exact line--chord normal form; the fixed first bridge chart alone does not determine its sign, and no root/cell/count is yet removed (D-0182/D-0183) |
