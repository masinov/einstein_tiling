...
from einstein.holonomy.alternating4.local_system import _deck_v4, _signed_coordinate
from einstein.combinatorics.finite_obstructions import deletion_minimal_obstruction
