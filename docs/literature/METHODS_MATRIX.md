...
| Sturmian lattice construction | `akiyama-hamada-ito-sturmian-2026` | theory notes `07`--`09`; no implementation | P0 slope and G0 common-support geometry proof drafts; S0 blocked on L0; natural three-role quotient refuted | The actual templates equalize to `30,30,2` triangles, but the limit creates point contacts. Prove a complete SAB/vertex decoder on the full limiting local closure before any address-table enumeration or carrier geometry. |
