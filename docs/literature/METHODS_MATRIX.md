...
| Sturmian lattice construction | `akiyama-hamada-ito-sturmian-2026` | `docs/theory/07_stm1_sturmian_monotile_design.md`, `08_stm1_equal_support_compiler.md`; no implementation | compiler proof-draft; source specialization blocked | S0C compiles connected common-cell macrotiles to one colored support. The source does not supply E-infinity for the Section 10.1 system; derive its exact common cell and transported SAB language before K1. Full-isometry handling still requires proved homochirality. |
