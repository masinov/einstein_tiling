...
| Forced clusters and hierarchy | `smkgs-hat-2024`, `smkgs-chiral-2024`, `cheritat-spectre-clusters-2024` | A6 and W3 | partial; frozen control | The unrestricted hull enters L18 and the exact finite correspondence is useful, but the remaining 80 radius-two survivors do not authorize another radius. Reopen only for a preregistered method-novelty proposition. |
