...
**Last updated:** 2026-07-24 (session 157 HC-36 transverse strand law)
...
| ST-M1 — Sturmian monotile encoding | outside-horizon theorem branch | 🟡 HC-36 active: the tangent stratum has an exact `8 -> 7` solver-variable presentation; transverse strand signs now have a radical-free root-selector criterion, but no selector sign or cell elimination is yet proved (D-0178--D-0180) |
