...
| Single-tile and small-support simulation | `greenfeld-tao-periodic-counterexample-2024`, `ollinger-fixed-polyominoes-2009`, `demaine-et-al-one-tile-2014`, `socolar-taylor-hexagonal-2011`, `akiyama-ammann-2012`, `lagae-kari-dutre-corner-2006`, `mampusti-whittaker-dendrite-2020`, `fletcher-atlas-2010` | K5C, theory note 19; `reviews/K5C_SINGLE_TILE_SIMULATION.md` | HC-14 audit: compiler architecture is prior art; ordinary gapless one-polygon realization remains open | Do not redesign the selector/trie/wires. Test at most one exact mechanism for bounded cycles, pre-decoding state visibility and contact completeness; otherwise close K5C without enumeration. |
