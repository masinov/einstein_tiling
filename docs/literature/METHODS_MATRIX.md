...
| Sturmian lattice construction | `akiyama-hamada-ito-sturmian-2026` | theory notes `07`--`12`; no implementation | Minimal colored S0 and symbolic K1P close in proof draft. K2C/K2V give an exact gauge-invariant boundary/sector factorization, but no unmarked geometry meets K2J's visible-sector, contact-completeness and lift contract. No monotile exists. | Active K2G is closed by the HC-09 kill condition. Reopen only for an exact polygon/gadget lemma satisfying J1--J6; no shape search or experiment. |
