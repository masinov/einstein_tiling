...
| Sturmian lattice construction | `akiyama-hamada-ito-sturmian-2026` | theory notes `07`--`10`; no implementation | P0/G0, auxiliary overlap contraction O0, and unique physical provenance I0 proof drafts; S0 blocked on D0; natural three-role quotient refuted | The three order cosets prevent physical vertex mergers in the limit. Prove a total global SAB/vertex decoder before any address-table enumeration or carrier geometry. |
