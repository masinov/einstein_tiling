...
**Last updated:** 2026-07-24 (session 160 HC-37 selector attack table)
...
| ST-M1 — Sturmian monotile encoding | outside-horizon theorem branch | 🟡 HC-37 active: both bridge-chart shortcuts fail; root monotonicity narrows twelve selector attacks to six, but no live root/cell or admitted count is removed (D-0182--D-0184) |
