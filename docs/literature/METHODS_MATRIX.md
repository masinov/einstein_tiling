...
| Sturmian lattice construction | `akiyama-hamada-ito-sturmian-2026` | theory notes `07`--`10`; no implementation | P0/G0/O0/I0/D0 give a minimal colored equal-triangle source in proof draft; natural role-only and independent-rail quotients refuted | Audit a proposed future-equivalence quotient of the full addressed source before any collar enumeration or carrier geometry; do not claim finite-`kappa` MLD or positive entropy. |
