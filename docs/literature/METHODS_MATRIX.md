...
| Sturmian lattice construction | `akiyama-hamada-ito-sturmian-2026` | theory notes `07`--`11`; no implementation | P0/G0/O0/I0/D0 give a minimal colored equal-triangle source; K1C gives a lossless coupled contact presentation; natural role-only and independent-rail quotients refuted | Prove the future-equivalence/local-inverse criterion for any nontrivial contact quotient before collar enumeration or carrier geometry; do not claim finite-`kappa` MLD or positive entropy. |
