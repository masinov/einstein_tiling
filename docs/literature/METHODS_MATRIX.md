...
| Binary square and rectangular SFT recoding | `hu-lin-two-color-square-2011`, `kari-moutot-low-complexity-2023`, `jeandel-rao-wang-2021` | K3B/B0; `reviews/BINARY_PLAQUETTE_RADIUS.md` | HC-12 targeted audit in progress; no implementation | Separate the Hu--Lin `2x2` binary corner no-go from Kari--Moutot's sufficiently long rectangular binary simulation, then compare both with the neighborhood one unmarked retiling gadget can actually see. |
