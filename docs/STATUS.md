...
**Last updated:** 2026-07-23 (session 135 non-right rhombic family derived)
...
| ST-M1 — Sturmian monotile encoding | outside-horizon theorem branch | ▶ HC-28 session 1/3: K22R/K22S derive the complete symbolic non-right rhombic family and recover N33's square system exactly; witness/no-go still open (D-0111--D-0151) |
