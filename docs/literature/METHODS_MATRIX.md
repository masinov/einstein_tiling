...
| T-junction / non-edge-to-edge contact complexes | `smkgs-chiral-2024`, `hellouin-lutfalla-vanier-geometric-2026`, `sugimoto-convex-edge-2015` | HC-15; `reviews/TJUNCTION_CONTACT_COMPLEX.md` | prior-art boundary audited; subdivision-order carrier not yet realized | Edge-patch atlases and FLC symbolic recodings are known. Test only the fixed fully occupied subdivision-word class; no general compiler or novelty claim. |
