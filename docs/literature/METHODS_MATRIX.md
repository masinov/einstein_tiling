...
| Sturmian lattice construction | `akiyama-hamada-ito-sturmian-2026` | no implementation | audited theorem-design target | The finite tile-set theorem is understood. Before any reproduction, design ST-M1 on paper: one unmarked disk whose full hull locally factors onto the three-tile `sqrt(2)-1` system. |
