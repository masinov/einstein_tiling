...
**Last updated:** 2026-07-24 (session 154 ERR-014: original HC-34 is live)
...
| ST-M1 — Sturmian monotile encoding | outside-horizon theorem branch | ▶ original HC-34 active: host inspection found S1-- still solving under its original three-hour supervisor; S1-+/S2-- failed pre-solver and will not retry; HC-35 was halted before launch, and the untouched second batch may follow under the repaired frozen-byte loader (ERR-014/D-0176) |
