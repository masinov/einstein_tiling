...
**Last updated:** 2026-07-24 (session 158 HC-36 closed)
...
| ST-M1 — Sturmian monotile encoding | outside-horizon theorem branch | ⏸ HC-36 closed: the tangent stratum has an exact `8 -> 7` solver-variable presentation; transverse roots have an exact strand-selector and partial order, but no root/cell is eliminated. K16W remains open/frozen pending a new method decision (D-0178--D-0181) |
