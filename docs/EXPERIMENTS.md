...
| 2026-07-16 | E1 hat A6 first blind candidate screen | exact A3-placement/module adapter; exact accelerated nearest-anchor mining; core-plus-halo SAT cover on the 11,514-tile disk | in progress — 160 rules screened, exactly 2 candidate 8/7 rules; both have two compositions and remain stable on cores of 2,277, 4,531 and 6,797 hats | `scripts/run_a6_hat.py`, `a6-hat-screen-results.json`, [notebook 10](notebook/2026-07-16-session-10.md) |
