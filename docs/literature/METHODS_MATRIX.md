...
| Sturmian lattice construction | `akiyama-hamada-ito-sturmian-2026` | theory notes `07`--`10`; no implementation | P0/G0 and auxiliary overlap contraction O0 proof drafts; S0 blocked on I0/D0; natural three-role quotient refuted | Auxiliary `P1/P2/P3` overlaps are not physical tile overlaps. Classify limiting physical point-contact provenance and prove a total SAB/vertex decoder before any address-table enumeration or carrier geometry. |
