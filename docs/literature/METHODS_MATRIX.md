...
| Single-tile and small-support simulation | `greenfeld-tao-periodic-counterexample-2024`, `ollinger-fixed-polyominoes-2009`, `demaine-et-al-one-tile-2014`, `stade-two-tiling-2025`, `socolar-taylor-hexagonal-2011`, `akiyama-ammann-2012`, `lagae-kari-dutre-corner-2006`, `mampusti-whittaker-dendrite-2020`, `fletcher-atlas-2010` | K5C, theory notes 19--20 and 67; `reviews/K5C_SINGLE_TILE_SIMULATION.md`; `reviews/MARKED_STURMIAN_UNDECIDABILITY.md` | The marked one-connected-polygon Sturmian compiler problem is undecidable by the factor-preserving Stade/product reduction; graph and fixed-cylinder auxiliaries are decidable. No gapless one-unmarked-polygon reduction follows. | Stop generic marked synthesis. The live general theorem is self-stapling color erasure: remove Stade's second staple support while preserving the all-tilings decoder, or prove why this cannot be done in a stated family. |
| T-junction / non-edge-to-edge contact complexes | `smkgs-chiral-2024`, `hellouin-lutfalla-vanier-geometric-2026`, `sugimoto-convex-edge-2015` | HC-15; theory note 21; `reviews/TJUNCTION_CONTACT_COMPLEX.md` | abstract `k!/2` order capacity proved; convex complementary-port realization refuted; no nonconvex polygon | Edge-patch atlases and FLC symbolic recodings are known. Reopen only with exact nonconvex coordinates and two hand-verified non-reversal patches before computation. |
