...
def test_hc38_cvc5_loader_parses_only_frozen_authenticated_bytes():
    path = ROOT / "scripts/historical/thin_lens/solve_tangent_cell.py"
...
def test_hc34_runner_loads_the_frozen_bytes_instead_of_reserializing():
    path = ROOT / "scripts/historical/thin_lens/solve_bounded_cell.py"
...
def test_hc35_launcher_isolates_cell_sessions(monkeypatch, tmp_path):
    path = ROOT / "scripts/historical/thin_lens/supervise_bounded_cells.py"
