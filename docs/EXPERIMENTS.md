...
| 2026-07-17 | W2.D binary-coupled S3 torus holonomy | at-least-cover placement relaxation; quotient-vertex/deck reconstruction; S3 potentials; all commuting twists; 39 inner-conjugacy classes; independently replayed DRAT cores | pass/new exact exclusions — periodic one-kite and shape-392 controls survive; a fixed map adds 0 kills among 96 W1 survivors at indices 40--60, but exhaustive class search kills all three index-40 survivors with six maps each. All 54 selected twist cores independently verify; area + T2.C4-36 + Layer D close every HNF through index 40 | [`theory-w2-layer-d-coupled.json`](notebook/assets/theory-w2-layer-d-coupled.json), [`theory-w2-layer-d-s3-classes.json`](notebook/assets/theory-w2-layer-d-s3-classes.json), [`theory-w2-layer-d-proof-index40.json`](notebook/assets/theory-w2-layer-d-proof-index40.json), `scripts/verify_theory_w2_layer_d_proofs.py`, [notebook 28](notebook/2026-07-17-session-28.md), D-0036 |
