...
| Sturmian lattice construction | `akiyama-hamada-ito-sturmian-2026` | theory notes `07`--`12`; no implementation | Minimal colored S0 and symbolic K1P close in proof draft. K2H/N6 give the sharp four-state symbolic factorization, but N7--N9 close pure orientation, bare `L/2L`, and their unanchored combination. No geometric phase or monotile exists. | Freeze K2G until an independently visible four-class contextual star or genuine ternary exact-cover junction is proposed on paper. No shape search or experiment is authorized. |
