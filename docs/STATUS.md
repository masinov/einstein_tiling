...
**Last updated:** 2026-07-24 (session 161 HC-37 thin-lens freeze)
...
| ST-M1 — Sturmian monotile encoding | outside-horizon theorem branch | ⏸ HC-37 frozen: selector attacks reduce to three same-cell conjugate-root obstructions, but variables/degree stay unchanged and all six cells retain two roots. Further thin-lens refinement is closed pending a certified tangent decision or carrier pivot (D-0182--D-0185) |
